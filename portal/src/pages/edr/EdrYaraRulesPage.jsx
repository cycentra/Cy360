      ...
      <div style={{ background: "#0d1120", border: T.border, borderTop: `2px solid ${T.accent}`,
        ...
        <div style={{ marginBottom: 16 }}>
          <div style={{ color: T.muted, fontSize: 10, marginBottom: 4, textTransform: "uppercase" }}>
            ...
            <span style={{ color: T.muted, marginLeft: 8, fontSize: 9 }}>
              Must be valid YARA syntax — validated server-side before storing
            </span>
          </div>
        ...
        <div style={{ marginTop: 18, padding: "10px 14px", background: "rgba(0,229,160,0.04)",
          ...
          <div style={{ color: T.muted, fontSize: 11, lineHeight: 1.7 }}>
            Once saved, this rule is immediately available at <code style={{ color: T.blue }}>/api/edr/installer/custom-yara</code>.
            All active agents fetch the merged ruleset on their <strong style={{ color: T.text }}>next hourly IOC sync</strong> (max 60 min wait)
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", zIndex: 1000,
      ...
      <div style={{ background: "#0d1120", border: T.border, borderTop: `2px solid ${T.orange}`,
        ...
        <div style={{ color: T.muted, fontSize: 11, lineHeight: 1.7, marginBottom: 16 }}>
          This pushes a <strong style={{ color: T.text }}>RUN_SCAN</strong> command to every active CyEDR agent.
          Agents scan their filesystem using both <code style={{ color: T.blue }}>cycentra.yar</code> and
          your active <code style={{ color: T.accent }}>custom.yar</code> rules. Results flow back
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", zIndex: 1000,
      ...
      <div style={{ background: "#0d1120", border: T.border, borderTop: `2px solid ${T.purple}`,
        ...
        <div style={{ marginBottom: 16 }}>
          <div style={{ color: T.muted, fontSize: 10, textTransform: "uppercase", marginBottom: 6 }}>YARA Rule Text</div>
...
// ── Main page ─────────────────────────────────────────────────────────────────
export default function EdrYaraRulesPage() {
  ...
  return (
    <div style={{ padding: "24px 28px", background: T.bg, minHeight: "100vh", color: T.text }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 4 }}>
            ...
            <Badge label="YARA RULES" color={T.accent} />
          </div>
          <div style={{ color: T.muted, fontSize: 12 }}>
            Upload analyst-authored YARA rules for zero-day hunting. Rules deploy to all CyEDR agents
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 24 }}>
        ...
        <KpiCard label="Total YARA Matches" value={totalMatches}
      ...
      <div style={{ background: "rgba(0,229,160,0.04)", border: "1px solid rgba(0,229,160,0.12)",
        ...
        {[
          { step: "1 — Write", color: T.accent, desc: "Author a YARA rule targeting zero-day indicators — file magic bytes, strings, PE structures, hashes." },
          { step: "2 — Upload", color: T.blue, desc: "Upload here. Platform validates YARA syntax and stores in the database. Rule goes live instantly." },
      ...
      {/* Rules table */}
      <Panel title="Custom YARA Rules" accent={T.purple} badge={rules.length}>
        {loading ? (
          ...
          <div style={{ color: T.muted, fontSize: 12, textAlign: "center", padding: "40px 0" }}>
            ...
            <div>No custom YARA rules yet.</div>
            <div style={{ marginTop: 6, fontSize: 11 }}>
              When a new zero-day is disclosed, click <strong style={{ color: T.accent }}>+ New YARA Rule</strong> to add a detection rule immediately.
            </div>
          </div>
        ) : (
      ...
      <div style={{ marginTop: 16, padding: "12px 16px", background: T.card, border: T.border,
        ...
        <div>
          ...
          <div style={{ color: T.text, fontSize: 11 }}>
            Every agent fetches <code style={{ color: T.blue }}>/api/edr/installer/custom-yara</code> on its hourly IOC sync.
            All active rules are merged and written to <code style={{ color: T.blue }}>custom.yar</code> on the endpoint.
          </div>
        </div>
        <div>
          <div style={{ color: T.muted, fontSize: 9, textTransform: "uppercase", marginBottom: 2 }}>
          ...
          <div style={{ color: T.text, fontSize: 11 }}>
            YARA matches flow into the <code style={{ color: T.accent }}>alerts</code> table. Hunt rules
