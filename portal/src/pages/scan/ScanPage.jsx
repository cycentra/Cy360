...
const SCAN_TIERS = [
  ...
  },
  {
    ...
    time: "~75s",
    desc: "Full surface coverage. Active probes. No AI.",
    note: "Standard scan covers all 12 detection modules — Deep Scan adds AI-powered root-cause analysis and step-by-step technical remediation.",
    features: [
      { label: "DNS & WHOIS lookup",               included: true  },
      ...
      { label: "OSINT & threat intel feeds",        included: true  },
      { label: "Dark web & breach monitoring",      included: true  },
      { label: "Supply chain JS risk",              included: true  },
      { label: "Social engineering intel",          included: true  },
      { label: "Mobile & API checks",               included: true  },
      { label: "AI enrichment & remediation",       included: false },
    ],
  },
  {
