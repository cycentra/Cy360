  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "comp-risks",     label: "Risk Register",         icon: SvgRisk,   accent: "#ff8c00" },
        { id: "comp-heatmap",   label: "Risk Heatmap",          icon: <span style={{ fontSize: 13 }}>🗺️</span>, accent: "#b06eff" },
        { id: "comp-appetite",  label: "Risk Appetite",         icon: <span style={{ fontSize: 13 }}>🎯</span>, accent: "#4d9eff" },
