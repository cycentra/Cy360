...
const SvgRules = <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>;
 ...
 *   ENDPOINT DEFENSE       — EDR Fleet · Detections · Response · Policies · Installer
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "detection-rules",      label: "Detection Rules",   icon: SvgRules, accent: "#4d9eff" },
