...
#
# Frameworks: nis2 | dora | gdpr | iso27001 | soc2 | nist_csf | pci_dss | eu_ai_act
#
...
# EU AI Act refs:    Art.9 (risk mgmt) | Art.14 (human oversight) | Art.15 (accuracy/robustness/cybersec) | Art.73 (incident reporting)
MITRE_TO_CONTROLS: Dict[str, Dict[str, List[str]]] = {
    ...
    "T1078": {
        ...
        "eu_ai_act": ["EU-AIAct-Art15-5", "EU-AIAct-Art14"],
    },
    ...
    "T1068": {
        ...
        "eu_ai_act": ["EU-AIAct-Art15-3", "EU-AIAct-Art15-5"],
    },
    ...
    "T1204": {
        ...
        "pci_dss":   ["Req 12.6"],
        "eu_ai_act": ["EU-AIAct-Art14", "EU-AIAct-Art15-5"],
    },
    ...
    "T1041": {
        ...
        "pci_dss":   ["Req 12.3"],
        "eu_ai_act": ["EU-AIAct-Art73", "EU-AIAct-Art15-5"],
    },
    ...
    "T1562": {
        ...
        "eu_ai_act": ["EU-AIAct-Art15-1", "EU-AIAct-Art9"],
    },
    ...
    "T1486": {
        ...
        "pci_dss":   ["Req 12.10"],
        "eu_ai_act": ["EU-AIAct-Art73", "EU-AIAct-Art15-1", "EU-AIAct-Art9"],
    },
}
