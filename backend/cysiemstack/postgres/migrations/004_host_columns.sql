-- =============================================================================
-- 004_host_columns.sql — Add host name column to incidents table
-- =============================================================================
-- Adds affected_agent_names array so the portal can display Host Name in the
-- Active Incidents table without requiring a separate agent lookup.
--
