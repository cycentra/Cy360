#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════════════
# CyCentra 360 -- Setup & Update Wizard v1.0.243 -- 2026-07-18 19:59 UTC
#
...
echo -e "  ${DIM}1. Verify alerts flowing: redis-cli -p 6379 llen cysiemstack:alerts:raw${NC}"
echo -e "  ${DIM}   (CyEDR/CyCollector/connectors feed this queue — check their bridge logs)${NC}"
echo -e "  ${DIM}2. Check engine log: tail -f /opt/cycentra/engine.log${NC}"
...
Next steps:
  1. Verify alerts flowing: redis-cli -p 6379 llen cysiemstack:alerts:raw
     (CyEDR/CyCollector/connectors feed this queue — check their bridge logs)
  2. Check engine log: tail -f /opt/cycentra/engine.log
